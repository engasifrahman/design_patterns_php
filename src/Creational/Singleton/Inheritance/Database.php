...
/**
 * Simple SQLite Database singleton using SingletonRegistry.
 *
 * Provides basic database operations with SQLite.
 */
class Database extends SingletonRegistry
{
    private ?PDO $pdo;
    ...
    public function disconnect(): bool
    {
        ...
        try {
            // Important: Set PDO to null to force connection closure
            $this->pdo = null;
            $this->isConnected = false;
     ...
     * Especially important for SQLite on Windows systems.
     *
     * @return void
     */
    private function performPostDisconnectCleanup(): void
    {
        // On Windows, SQLite often keeps file locks for a short time
